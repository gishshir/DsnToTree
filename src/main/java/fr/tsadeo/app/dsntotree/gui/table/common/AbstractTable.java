...
public abstract class AbstractTable<T extends ITableItemDto> extends JTable {
    ...
    protected AbstractTable(IMyTableModel<T> tableModel, TableColumnModel tableColumnModel,
    ...
    private void buildListSelectionListener() {
        ...
        this.getSelectionModel().addListSelectionListener(e -> {
            ...
            int[] selectedRows = AbstractTable.this.getSelectedRows();
