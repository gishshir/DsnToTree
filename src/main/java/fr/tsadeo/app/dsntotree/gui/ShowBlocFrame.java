...
public class ShowBlocFrame extends AbstractFrame implements ItemBlocListener, IDsnListener {
    ...
    // ---------------------------------------------- constructor
    protected ShowBlocFrame(String title, String pathItemBloc, String description, IMainActionListener listener) {
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                ...
                MySwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ListItemBlocListenerManager.get().removeItemBlocListener((ItemBlocListener) ShowBlocFrame.this);
                        ListDsnListenerManager.get().removeDsnListener((IDsnListener) ShowBlocFrame.this);
                    }
                });
            }
        });
