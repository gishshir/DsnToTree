...
public abstract class AbstractMyTableModel<T extends ITableItemDto> extends AbstractTableModel
    ...
    protected AbstractMyTableModel(Column[] tabColumns, RowMapper<T> rowMapper) {
