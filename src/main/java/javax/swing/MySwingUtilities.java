 ...
 * @author unknown
 */
public class MySwingUtilities implements SwingConstants {
    ...
    static Point convertScreenLocationToParent(Container parent, int x, int y) {
        for (Container p = parent; p != null; p = p.getParent()) {
            if (p instanceof Window) {
                ...
                MySwingUtilities.convertPointFromScreen(point, parent);
                return point;
            }
        }
    ...
    public static MouseEvent convertMouseEvent(Component source, MouseEvent sourceEvent, Component destination) {
        ...
        if (sourceEvent instanceof MouseWheelEvent) {
            ...
            newEvent = new MouseWheelEvent(newSource, sourceWheelEvent.getID(), sourceWheelEvent.getWhen(),
                    ...
                    sourceWheelEvent.getXOnScreen(), sourceWheelEvent.getYOnScreen(), sourceWheelEvent.getClickCount(),
                    sourceWheelEvent.isPopupTrigger(), sourceWheelEvent.getScrollType(),
                    sourceWheelEvent.getScrollAmount(), sourceWheelEvent.getWheelRotation());
    ...
    static Frame getSharedOwnerFrame() throws HeadlessException {
        Frame sharedOwnerFrame = (Frame) MySwingUtilities.appContextGet(sharedOwnerFrameKey);
        if (sharedOwnerFrame == null) {
            sharedOwnerFrame = new SharedOwnerFrame();
            MySwingUtilities.appContextPut(sharedOwnerFrameKey, sharedOwnerFrame);
        }
    ...
    static void updateRendererOrEditorUI(Object rendererOrEditor) {
        ...
        if (component != null) {
            MySwingUtilities.updateComponentTreeUI(component);
        }
    }
